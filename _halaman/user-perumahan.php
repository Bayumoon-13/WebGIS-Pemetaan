...
<html lang="en">
    ...
    <body class="bg-shape">
                ...
                <div class="row align-items-center text-center text-md-left">
                    <div class="col-md-6 col-lg-5 mb-5 mb-md-0">
                        ...
                        <p class="text-justify">
                            Selamat datang di halaman "Data Perumahan" kami !!! Halaman ini dirancang khusus untuk membantu 
                            Anda mengakses dan melihat data perumahan yang terdata di wilayah Kecamatan Rancaekek dengan mudah dan cepat
                        </p>
        ...
        <hr>
        <section class="hero-banner magic-ball" style="margin-bottom: 600px; margin-top: -100px;">
            <div class="section-intro text-center pb-90px">
                <img class="section-intro-img" src="assets/images/folder.png" alt="">
                <h2>Master Data Perumahan <br>
                    Kecamatan Rancaekek
                </h2>
                <p>Tabel informasi perumahan yang berada di Kecamatan Rancaekek </p>
                <hr>
            </div>
            <div class="col-md-8 text-center mx-auto">
                <div class="data-count">
                    ...
                    ?>
                    <h3>Jumlah Data Perumahan: <?php echo $dataCount; ?></h3>
                </div>
                            ...
                            foreach ($getdata as $row) {
                                ?>
                                    <tr>
                                        ...
                                        <td class="ctr">
                                            <div class="btn-group">
                                                <button class="detail-button" onclick="window.location.href='detail.php?id_lokasi=<?= $row->id_lokasi ?>'">
